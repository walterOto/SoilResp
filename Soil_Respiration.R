...
# Data --------------------------------------------------------------------------------------------
Rs_piura <- read.csv("./Data/Rs_Piura_2017&2018.csv") # piura data
Rs_glob  <- read.csv("./Data/Soil_resp_global.csv") # global data
Soil_Hum <- read.csv("./Data/Hum_slo.csv") 
Das_dat  <- read.csv("./Data/Dasometric_data.csv")
...
tiff("./Outputs/1)Rs outside and under canopy in summer and winter.tiff", 
...
tiff("./Outputs/2)Rs in summer and winter.tiff", 
     width = 12, height = 4.5, units = 'in', res = 300, compression = 'lzw')
...
tiff("./Outputs/3)Rs correlation with canopy area, soil temperature and soil humidity.tiff", 
